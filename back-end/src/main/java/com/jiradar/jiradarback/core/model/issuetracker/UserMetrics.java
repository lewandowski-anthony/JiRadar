...
public class UserMetrics {
	...
	private final double parallelIssuesInProgressRate;
	private final Map<String, Double> issueRateByType;
	...
	public static UserMetrics generate(User user, List<Issue> projectIssues, DateRange range) {
		...
		return UserMetrics.builder()
				...
				.parallelIssuesInProgressRate(metricsService.calculateParallelJiraInProgressRate())
				.issueRateByType(metricsService.getDoneIssuesTypeDistribution())
				.build();
	}
}